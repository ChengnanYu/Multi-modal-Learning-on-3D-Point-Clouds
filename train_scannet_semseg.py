...
from data_utils.ScanNetDataLoader import ScannetDataset, ScannetDatasetWholeScene
import datetime
import logging
...
def main(args):
    ...
    test_dataset = ScannetDatasetWholeScene(root = './data', split='test', npoints=8192)
